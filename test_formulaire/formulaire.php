...
//on préparer le mail:
$MAIL['envoyer_a']		= "polo14740@gmail.com";//(destinataire) mettez votre adresse mail ou l'adresse mail d'un autre destinataire (pour envoyer à plusieurs dstinataires, séparez par une virgules les adresses)
